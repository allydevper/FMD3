...
fn main() {
    let _ = fmd3_lib::lua_host::ensure_loaded();
    let tmo = fmd3_lib::lua_host::find_by_id("9185eb6c49324a849c7d7925a41ef3a3")
    ...
    let eh = fmd3_lib::lua_host::find_by_id("f7ab487b6d29468e8280e8a3cbebbeb4")
    ...
    let niadd = fmd3_lib::lua_host::find_by_id("482deba9267346418abf3d381712e87a")
